...
urlpatterns = [
    ...
    path('advance-search-report', report_views.advanced_report_filtering, name='report_advance_search'),
    path('add-report-add-client', report_views.add_report_with_client, name='report_new_client_new'),
    ...
    path('reports', report_views.filter_reports, name='report_list'),
    ...
    path('clients', report_views.filter_clients, name='client_list'),
    ...
    path('accounts/need-permission/', auth_views.LoginView.as_view(template_name="accounts/need-permission.html", authentication_form=UserLoginForm), name="need_permission"),
    ...
    path("pdf-report/<int:pk>", report_views.new_pdf_page, name="report_pdf"),
